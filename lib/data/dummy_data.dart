...
const dummyMeals = [
  ...
  Meal(
    ...
    steps: [
      'Toast bread slices.',
      'Rub garlic onto each slice.',
      'Top with diced tomatoes, basil, oil, salt, and pepper.',
    ],
    isGlutenFree: false,
    isVegan: true,
    isVegetarian: true,
  ...
  Meal(
    ...
    steps: [
      ...
      'Assemble with sauce, onion, and lettuce.',
    ],
    isGlutenFree: false,
    isVegan: false,
    isVegetarian: false,
  ...
  Meal(
    ...
    steps: [
      'Stir-fry paste in oil.',
      'Add coconut milk and simmer.',
      'Incorporate protein and veggies.',
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://sp-ao.shortpixel.ai/client/to_auto,q_lossless,ret_img,w_800/https://www.thetakeiteasychef.com/wp-content/uploads/2017/04/SO-Insta.jpg',
    duration: 10,
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://img.freepik.com/premium-photo/homemade-fresh-fruit-lemon-sorbet-ice-cream-white-bowl_1048944-8422143.jpg?w=740',
    duration: 120,
    ingredients: ['Lemon Juice', 'Sugar', 'Water', 'Lemon Zest'],
    steps: [
      'Heat water and sugar until dissolved.',
      'Stir in juice and zest.',
      'Freeze and stir occasionally until firm.',
    ],
    isGlutenFree: true,
    isVegan: true,
    isVegetarian: true,
